Автоматизированные тесты для переключения языков coinmarketcap.com
----
...
**Альтернативный вариант проверки** - видео с выполнением на моей машине. https://youtu.be/HQuhanFjVzY (и это видео тоже записано на телефон ¯_(ツ)_/¯
